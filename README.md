...
Compared to UE4, the plugin is **1.7x** smaller, **3x** more accurate, **30x** faster to compress, and up to **7.5x** faster to decompress (compared to *UE 4.19.2*, results may vary)!
